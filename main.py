...
from llm_config import check_ollama_available, OLLAMA_MODEL, OLLAMA_BASE_URL
...
def preflight_check():
    ...
    print(f"[{'OK' if ollama_ok else 'TIDAK TERJANGKAU'}] Ollama server di {OLLAMA_BASE_URL} (model: {OLLAMA_MODEL})")
    print()
    return all_ok, ollama_ok
...
def main():
    ...
    data_ok, ollama_ok = preflight_check()
    ...
    if not ollama_ok:
        print(
            ...
            "Sistem ini butuh Ollama untuk reasoning tiap agent (orchestrator, sintesis jawaban).\n"
